...
export const SignUpContainer = styled.div<IProps>`
...
export const SignUpHeaderText = styled.h1<IProps>`
  color: ${(props) => props.colors.mainColor};
  margin: 50px 0;
  font-size: 50px;
`;

export const SignUpInputs = styled.input<IProps>`
  background-color: ${(props) => props.colors.background};
  text-align: center;
  font-size: 25px;
  padding: 15px;
...
`;
export const FormSignUp = styled.form<IProps>`
  background-color: ${(props) => props.colors.cardColor};
  width: 100%;
  height: 500px;
  padding-bottom: 20px;
